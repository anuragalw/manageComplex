...
public class SmsService {
	...
	private final String LOGIN_URL    = "http://fullonsms.com/login.php";
	 ...
	 SmsService(String username,String password){
	 ...
	 public static void main(String[] args) {
	  ...
	  String username = "9241370162";
	  //Replace DEMO_PASSWORD with password of your account
	  String password = "10101983";
	  //Replace TARGET_MOBILE with a valid mobile number 
	  String toMobile = "9241370162";
	  
	  String toMessage = "Test message ";
	  
	  SmsService fullOnSMS = new SmsService(username, password);
	  try{
