...
import com.manage.complex.util.SMS;
import com.manage.complex.util.NotAuthenticatedException;
import com.manage.complex.util.Way2SMS;
...
public class SMS160by2 implements SMS{
    ...
    public static void main(String[] args) throws NotAuthenticatedException {
    	if (true) {
    	...
    	SMS160by2 fullonSMS = new SMS160by2();
    	fullonSMS.setDebug(true);
    	fullonSMS.login("9241370162", "4352");
    	fullonSMS.send("9241370162", "Hi Amrendra");
    }
}
